...
require 'mappings'
-- load local env configs
if vim.env.NVIM_CLASS_ENV == 'csci311' then
  dofile(vim.fn.expand '~/Documents/Schooldir/Fall 25/algs/csci311.lua')
end
...
--  Use CTRL+<mnei> to switch between windows
--
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      vim.diagnostic.config {
        virtual_text = true, -- show inline messages (next to the squiggle)
